...
class CTN_Widget_Recently_Viewed extends WP_Widget {
	 ...
	 * @return void
	 */
	function CTN_Widget_Recently_Viewed() {

		/* Widget variable settings. */
		$this->woo_widget_cssclass = 'carton widget_recently_viewed_products';
		$this->woo_widget_description = __( 'Display a list of recently viewed products.', 'carton' );
		$this->woo_widget_idbase = 'carton_recently_viewed_products';
		$this->woo_widget_name = __( 'CartoN Recently Viewed Products', 'carton' );
	...
	function widget($args, $instance) {
		...
		$viewed_products = ! empty( $_COOKIE['carton_recently_viewed'] ) ? (array) explode( '|', $_COOKIE['carton_recently_viewed'] ) : array();
		...
		$title = apply_filters('widget_title', empty( $instance['title'] ) ? __( 'Recently viewed', 'carton' ) : $instance['title'], $instance, $this->id_base);
