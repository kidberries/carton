 ...
 * @return void
 */
function carton_product_synonyms_box() {
	global $post;
	...
	?>
    <p><?php __('Site Search Engine synonyms / keywords', 'carton'); ?></p>
	<p style="width: 100%">
		<?php carton_wp_textarea_input( array(
            'id'          => '_synonyms_variable',
            'class'       => 'large',
            'label'       => __( 'Synonyms/Keywords variable part', 'carton' ),
            'description' => __( 'Comma separated synonyms words or keywords for search engine of the site. You can place here a variable part of them you think.', 'carton' ),
	...
	<p style="width: 100%">
		<?php carton_wp_textarea_input( array(
            'id'          => '_synonyms_base',
            'class'       => 'large',
            'label'       => __( 'Synonyms/Keywords base part', 'carton' ),
            'description' => __( 'Comma separated synonyms words or keywords for search engine of the site. You can place here a base part of them you think.', 'carton' ),
            'value'       => $keywords_base,
            'name'        => '_synonyms_base',
        ) ); ?>
	</p>
