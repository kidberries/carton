jQuery(document).ready(function($) {
	...
	$(document).on( 'click', '.shipping-calculator-button', function() {
        ...
        var data = {
            action: 		            'carton_update_shipping_method',
...
*/
	        $('div.cart_totals').block({message: null, overlayCSS: {background: '#fff url(' + carton_params.ajax_loader_url + ') no-repeat center', backgroundSize: '16px 16px', opacity: 0.6}});
