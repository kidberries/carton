<?php
/**
 * CTN_Product_Cat_List_Walker class.
 *
 * @extends 	Walker
 * @class 		CTN_Product_Cat_Dropdown_Walker
 * @version		1.6.4
 * @package		CartoN/Classes/Walkers
 * @author 		CartonThemes
 */

if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly

class CTN_Product_Cat_List_Walker extends Walker {
	...
	function start_el( &$output, $cat, $depth, $args ) {
		...
		$output .=  '"><a href="' . get_term_link( (int) $cat->term_id, 'product_cat' ) . '">' . __( $cat->name, 'carton' ) . '</a>';
