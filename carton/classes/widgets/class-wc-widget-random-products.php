...
class CTN_Widget_Random_Products extends WP_Widget {
	...
	function __construct() {
		$this->id_base = 'carton_random_products';
		$this->name    = __( 'CartoN Random Products', 'carton' );
		$this->widget_options = array(
			'classname'   => 'carton widget_random_products',
			'description' => __( 'Display a list of random products on your site.', 'carton' ),
		);
	...
	function widget( $args, $instance ) {
		...
		$title = ( '' === $instance['title'] ) ? __('Random Products', 'carton' ) : $instance['title'];
