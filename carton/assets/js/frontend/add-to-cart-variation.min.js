 ...
 * Variations Plugin
 */
(function(b,l,p,m){b.fn.ctn_variation_form=function(){b.fn.ctn_variation_form.find_matching_variations=function(d,a){var f=[];this.variations={};for(var e=0;e<d.length;e++){var c=d[e];this.variations[c.variation_id]=c.taxonomy;b.fn.ctn_variation_form.variations_match(c.attributes,a)&&f.push(c)}return f};b.fn.ctn_variation_form.variations_match=function(b,a){var f=!0;for(attr_name in b){var e=b[attr_name],c=a[attr_name];e!==m&&(c!==m&&0!=e.length&&0!=c.length&&e!=c)&&(f=!1)}return f};this.unbind("check_variations update_variation_values found_variation");
this.find(".reset_variations").unbind("click");this.find(".variations select").unbind("change focusin");return this.on("reset",function(){b(this).ctn_variation_form();b(this).closest(".variations select").change()}).on("change",'input[name="variation_id"]',function(){if(b(this).val()&&"object"===typeof b.fn.ctn_variation_form.variations[b(this).val()]){var d=b.fn.ctn_variation_form.variations[b(this).val()],a;for(a in d)for(var f in d[a]){var e=[".changeable.attribute."+a+" ."+f,".changeable.attribute."+
...
".variations select",function(){$variation_form=b(this).closest("form.variations_form");$variation_form.find("input[name=variation_id]").val("").change();$variation_form.trigger("carton_variation_select_change").trigger("check_variations",["",!1]);b(this).blur();b().uniform&&b.isFunction(b.uniform.update)&&b.uniform.update()}).on("focusin",".variations select",function(){$variation_form=b(this).closest("form.variations_form");$variation_form.trigger("carton_variation_select_focusin").trigger("check_variations",
[b(this).attr("name"),!0])}).on("check_variations",function(d,a,f){var e=!0,c=!1,h={};d=b(this);var g=d.find(".reset_variations");d.find(".variations select").each(function(){0==b(this).val().length?e=!1:c=!0;a&&b(this).attr("name")==a?(e=!1,h[b(this).attr("name")]=""):(value=b(this).val(),h[b(this).attr("name")]=value)});var j=parseInt(d.data("product_id")),k=d.data("product_variations");k||(k=l.product_variations[j]);k||(k=l.product_variations);k||(k=l["product_variations_"+j]);j=b.fn.ctn_variation_form.find_matching_variations(k,
h);e?(j=j.pop())?(d.find("input[name=variation_id]").val(j.variation_id).change(),d.trigger("found_variation",[j])):(d.find(".variations select").val(""),f||d.trigger("reset_image"),alert(carton_params.i18n_no_matching_variations_text)):(d.trigger("update_variation_values",[j]),f||d.trigger("reset_image"),a||d.find(".single_variation_wrap").slideUp("200"));c?"hidden"==g.css("visibility")&&g.css("visibility","visible").hide().fadeIn():g.css("visibility","hidden")}).on("reset_image",function(){var d=
...
g+'"]').addClass("active")):current_attr_select.find("option:gt(0)").addClass("active"))}}current_attr_select.find("option:gt(0):not(.active)").remove()});$variation_form.trigger("carton_update_variation_values")}).on("found_variation",function(d,a){var f=b(this),e=b(".product"),c=e.find("div.images img:eq(0)"),h=e.find("div.images a.zoom:eq(0)"),g=c.attr("data-o_src"),j=c.attr("data-o_title"),k=h.attr("data-o_href"),l=a.image_src,m=a.image_link,n=a.image_title;f.find(".variations_button").show();
