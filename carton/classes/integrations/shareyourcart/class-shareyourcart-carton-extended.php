...
require_once( "class.shareyourcart-wp-carton.php" );

/**
 * ShareYourCartCartoNEx class.
 *
 * @extends ShareYourCartCartoN
 */
class ShareYourCartCartoNEx extends ShareYourCartCartoN {
	...
	function __construct( $settings ) {
		...
		// disable analytics for the carton integration
	...
	/**
	 * Since this class has loaded, the CartoN plugin is active.
	 *
	 * @access public
	 * @return bool
	 */
	...
	protected function setConfigValue( $field, $value ) {
		...
		update_option( 'carton_shareyourcart_settings', $this->settings );
	}
