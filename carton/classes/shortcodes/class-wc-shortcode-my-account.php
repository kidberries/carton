 ...
 * @author 		CartonThemes
 * @category 	Shortcodes
 * @package 	CartoN/Shortcodes/My_Account
 * @version     2.0.0
 */

class CTN_Shortcode_My_Account {
	...
	public static function output( $atts ) {
		...
		if ( ! is_user_logged_in() ) {
			...
			carton_get_template( 'myaccount/form-login.php' );
			...
			carton_get_template( 'myaccount/my-account.php', array(
