<?php
/**
 * CartoN Payment Gateways class
 *
 * Loads payment gateways via hooks for use in the store.
 *
 * @class 		CTN_Payment_Gateways
 * @version		1.6.4
...
class CTN_Payment_Gateways {
    ...
    function init() {
    	...
    	$load_gateways = apply_filters( 'carton_payment_gateways', array() );

		// Get order option
		$ordering 	= (array) get_option('carton_gateway_order');
		$order_end 	= 999;
	...
	function get_available_payment_gateways() {
		...
		return apply_filters( 'carton_available_payment_gateways', $_available_gateways );
	}
	...
	function process_admin_options() {
		...
		update_option( 'carton_default_gateway', $default_gateway );
		update_option( 'carton_gateway_order', $order );
	}
}