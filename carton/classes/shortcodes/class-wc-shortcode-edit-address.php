 ...
 * @author 		CartonThemes
 * @category 	Shortcodes
 * @package 	CartoN/Shortcodes/Edit_Address
 * @version     2.0.0
 */

class CTN_Shortcode_Edit_Address {
	...
	public static function output( $atts ) {
		...
		$address = $carton->countries->get_address_fields( get_user_meta( get_current_user_id(), $load_address . '_country', true ), $load_address . '_' );

		carton_get_template( 'myaccount/form-edit-address.php', array(
