...
class CTN_Widget_Featured_Products extends WP_Widget {
	 ...
	 * @return void
	 */
	function CTN_Widget_Featured_Products() {

		/* Widget variable settings. */
		$this->woo_widget_cssclass = 'carton widget_featured_products';
		$this->woo_widget_description = __( 'Display a list of featured products on your site.', 'carton' );
		$this->woo_widget_idbase = 'carton_featured_products';
		$this->woo_widget_name = __( 'CartoN Featured Products', 'carton' );
	...
	function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Featured Products', 'carton' ) : $instance['title'], $instance, $this->id_base);
