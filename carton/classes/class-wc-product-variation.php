 ...
 *
 * The CartoN product variation class handles product variation data.
 *
 * @class 		CTN_Product_Variation
 * @version		2.0.0
 * @package		CartoN/Classes
 * @category	Class
 * @author 		CartonThemes
 */
class CTN_Product_Variation extends CTN_Product {
	...
	public function is_visible() {
		...
		if ( get_option('carton_hide_out_of_stock_items') == 'yes' && ! $this->is_in_stock() )
			$visible = false;
	...
	public function get_file_download_path( $download_id ) {
		...
		$file_path = '';
		$file_paths = apply_filters( 'carton_file_download_paths', get_post_meta( $this->variation_id, '_file_paths', true ), $this->variation_id, null, null );
		...
		return apply_filters( 'carton_file_download_path', $file_path, $this->variation_id, $download_id );
	}
}