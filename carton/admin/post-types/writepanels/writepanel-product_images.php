 ...
 * @return void
 */
function carton_product_images_box() {
	global $post;
	?>
				...
				if ( $attachments )
					foreach ( $attachments as $attachment_id ) {
						echo '<li class="image" data-attachment_id="' . $attachment_id . '">
							...
							<ul class="actions">
								<li><a href="#" class="delete" title="' . __( 'Delete image', 'carton' ) . '">' . __( 'Delete', 'carton' ) . '</a></li>
							</ul>
						</li>';
					}
			?>
	...
	<p class="add_product_images hide-if-no-js">
		<a href="#"><?php _e( 'Add product gallery images', 'carton' ); ?></a>
	</p>
		...
		jQuery(document).ready(function($){
			...
			jQuery('.add_product_images').on( 'click', 'a', function( event ) {
				...
				product_gallery_frame = wp.media.frames.downloadable_file = wp.media({
					...
					title: '<?php _e( 'Add Images to Product Gallery', 'carton' ); ?>',
					button: {
						text: '<?php _e( 'Add to gallery', 'carton' ); ?>',
					},
					multiple: true
				});
						...
						if ( attachment.id ) {
							...
							$product_images.append('\
								<li class="image" data-attachment_id="' + attachment.id + '">\
									...
									<ul class="actions">\
										<li><a href="#" class="delete" title="<?php _e( 'Delete image', 'carton' ); ?>"><?php _e( 'Delete', 'carton' ); ?></a></li>\
									</ul>\
								</li>');
						}
