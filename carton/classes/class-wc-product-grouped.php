 ...
 *
 * @class 		CTN_Product_Grouped
 * @version		2.0.0
 * @package		CartoN/Classes/Products
 * @category	Class
 * @author 		CartonThemes
 */
class CTN_Product_Grouped extends CTN_Product {
	...
	public function get_price_html( $price = '' ) {
		...
		$price .= carton_price( $min_price );

		$price = apply_filters( 'carton_grouped_price_html', $price, $this );
