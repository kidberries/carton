...
<div class="wrap">
    ...
    <div id="visual-options">
    	<table class="form-table">
    		<tr>
    			<th class="titledesc" scope="row"><?php _e( 'Button style', 'carton' ); ?></th>
    			<td class="forminp">
    				<fieldset>
    					<legend class="screen-reader-text"><span><?php _e( 'Button style', 'carton' ); ?></span></legend>
						<p>
							<label>
        ...
        <div class="submit">
        	<input type="submit" class="button button-primary" name="syc-visual-form" value="<?php _e('Save changes', 'carton'); ?>" />
        </div>
    </div>
</div>