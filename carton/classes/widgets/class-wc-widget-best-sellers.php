...
class CTN_Widget_Best_Sellers extends WP_Widget {
	 ...
	 * @return void
	 */
	function CTN_Widget_Best_Sellers() {

		/* Widget variable settings. */
		$this->woo_widget_cssclass = 'carton widget_best_sellers';
		$this->woo_widget_description = __( 'Display a list of your best selling products on your site.', 'carton' );
		$this->woo_widget_idbase = 'carton_best_sellers';
		$this->woo_widget_name = __( 'CartoN Best Sellers', 'carton' );
	...
	function widget( $args, $instance ) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Best Sellers', 'carton' ) : $instance['title'], $instance, $this->id_base);
	...
	function form( $instance ) {
		...
		<label for="<?php echo $this->get_field_id('hide_free'); ?>"><?php _e( 'Hide free products', 'carton' ); ?></label></p>
