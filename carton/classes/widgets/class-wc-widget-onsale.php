...
class CTN_Widget_Onsale extends WP_Widget {
	 ...
	 * @return void
	 */
	function CTN_Widget_Onsale() {

		/* Widget variable settings. */
		$this->woo_widget_cssclass = 'carton widget_onsale';
		$this->woo_widget_description = __( 'Display a list of your on-sale products on your site.', 'carton' );
		$this->woo_widget_idbase = 'carton_onsale';
		$this->woo_widget_name = __( 'CartoN On-sale', 'carton' );
	...
	function widget( $args, $instance ) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('On Sale', 'carton' ) : $instance['title'], $instance, $this->id_base);
