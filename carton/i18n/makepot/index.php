<?php
/**
 * Web interface for generating the CartoN POT files
 *
 * @since 2.0
 * @package CartoN
...
<head>
	...
	<meta charset="utf-8">
	<title>CartoN POT Generator</title>
	<style>
...
<body>
	...
	<h1>CartoN <?php echo $makepot->carton_version() ?> POT Generator</h1>
	...
	<p>This tool will (re)generate and overwrite the following CartoN POT-files:</p>
